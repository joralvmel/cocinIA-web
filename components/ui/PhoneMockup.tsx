...
export function PhoneMockup({ children, className = '' }: PhoneMockupProps) {
  return (
    <div className={`relative mx-auto h-[520px] w-[260px] rounded-[2.6rem] border border-black/45 bg-[#111827] p-2 shadow-[0_36px_80px_-36px_rgba(0,0,0,0.65)] dark:border-white/10 ${className}`}>
